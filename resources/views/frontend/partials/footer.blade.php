...
<form id="__form" action="/action_page.php">
  <div class="container" style="background-color:white">
    <input class="__input" type="text" placeholder="Phone" name="phone" required>
    <input class="__input" type="text" placeholder="Email address" name="email" required>
  </div>

  <center>Subscribe for latest property deals & discounts.</center>

  <div class="container">
    <input id="__submit" type="submit" value="Subscribe">
  </div>
</form>
